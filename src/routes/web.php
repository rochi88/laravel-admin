...
use Rochi88\Admin\Facades\Calculator;
use Rochi88\Admin\Http\Controllers\Common\Dashboard;
use Rochi88\Admin\Http\Controllers\Sales\InvoiceController;
use Rochi88\Admin\Http\Controllers\Settings\Setup;
...
$namesapce = 'Rochi88\\Admin\\Http\\Controllers';
...
->group(function(){
    ...
    Route::get('test', function () {
        $obj = json_to_object(json_encode(['name'=>'Rochi88', 'loc'=>'Duum Dum']), true);
        return $obj;
    });
});
