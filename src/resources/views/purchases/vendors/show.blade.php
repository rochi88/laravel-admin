<x-admin-base nosidebar title="Vendor Details" item2="Vendors" link2="{{ route('admin.vendors.index') }}">
<div class="row">
    <div class="col-md-3">
        <ul class="list-group">
            <li class="list-group-item  align-items-center">
                <h3>Rochi88 Debnath</h3>
    ...
    <div class="col-md-9">
        <div class="row">
            <x-admin-helpdesk title="Paid"></x-admin-helpdesk>
            <x-admin-helpdesk title="Open Invoices"></x-admin-helpdesk>
            <x-admin-helpdesk title="Overdue Invoices"></x-admin-helpdesk>
        </div>
        <div class="card">
            <div class="card-body">
